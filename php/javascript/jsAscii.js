var jsAscii = (function () {
	...
	var aDefaultColorCharList = (" .,:;itfLCG08@").split("");
	...
	function asciifyImage(oImg, oCanvasImg) {
		...
		var iScale = parseInt(oImg.getAttribute("asciiscale"), 10) || 1;
		...
		var aCharList = oImg.getAttribute("asciichars") || (bColor ? aDefaultColorCharList : aDefaultCharList);
		var fResolution = 0.5;
		...
		var iWidth = Math.round(parseInt(oImg.offsetWidth, 10) * fResolution);
		var iHeight = Math.round(parseInt(oImg.offsetHeight, 10) * fResolution);
